...
window.I18N = (() => {
  ...
  const dicts = {
    ...
    tr: {
      ...
      instructions: 'Karanlık yere düşmeden önce gölgeleri yok et.<br>Hiç kaçırma — kesintisiz her kombo<br>krallığa ışığı geri getirir.',
      startBtn: 'Başla ✦ 30 saniye',
      hint: 'fare veya dokunmatik · acele et',
      scoreLabel: 'skor',
      comboLabel: 'kombo',
      ...
      rankQueenTitle: 'Neo Queen Serenity',
      rankQueenFlavor: 'Kristal Tokyo sonsuza dek parlıyor. Aydınlık kazandı!',
      rankPrincessTitle: 'Prenses Serenity',
      rankPrincessFlavor: 'Kristal kulelerin üzerinde şafak söküyor. Kurtuluşa çok az kaldı.',
      rankSuperTitle: 'Super Sailor Moon',
      rankSuperFlavor: 'Gölgeler geri çekiliyor — umut var.',
      rankGuardianTitle: 'Sailor Moon',
      rankGuardianFlavor: 'Kranlığa karşı savaş başladı.',
